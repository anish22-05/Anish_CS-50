'''1. What a program that asks the user for their age and prints, You are eligible to vote, 
...
'''2. Given a number, print "Even" if it's even and "Odd" if it's odd.'''
# num = int(input("Enter a number: "))
# if num % 2 == 0:
#     print("Number is Even.")
# else: 
#     print("Number is Odd.")
'''3. Write a program that asks the user for their grade (0-100) 
