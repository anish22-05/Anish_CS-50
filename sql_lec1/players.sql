...
SELECT bats,throws FROM players WEHRE first_name = "Babe" AND last_name = "Ruth";
...
SELECT first_name, last_name FROM players WHERE birth_country != "United States" ORDER BY first_name ASC, last_name ASC;
...
SELECT first_name, last_name, debut FROM players WHERE birth_city = "Pittsburgh" AND birth_state = "PA"
...
<--of baseball players who debuted on or after January 1st, 
<--2000.Return the columns with the name “Average Height” and “Average Weight”, respectively.
...
<-- write SQL query to answer a question of your choice. This query should:
    ...
    -- Sort by at least one column using ORDER 
SELECT id AS "final_game_playing_players_id", first_name,last_name,bats,throws FROM players 
WHERE final_game BETWEEN "2023-01-01" AND "2023-12-31" ORDER BY first_name, last_name;
